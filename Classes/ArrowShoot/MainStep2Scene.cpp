...
bool MainStep2Scene::init(){
	...
	/*加载地图*/
	setMap(Factory::createMapLayer(MapStep2));
	...
	setArrowLayer(Factory::createArrowSpriteLayer(ArrowSpriteStep2));


	/*加载怪物*/
	setMonsterLayer(Factory::createMonsterSpriteLayer(MonsterSpriteStep2));
...
void MainStep2Scene::onEventHappen(Layer * object, MyEvent e)
{
	...
	case NoMonster: {
		...
		Director::getInstance()->replaceScene(
			TransitionSplitRows::create(3.0f, Factory::createMainScene(MainStep3)));
