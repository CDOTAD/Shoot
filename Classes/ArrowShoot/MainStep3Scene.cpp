...
bool MainStep3Scene::init(){
	...
	/*加载地图*/
	setMap(Factory::createMapLayer(MapStep3));

	setCommonPart();
	/*加载箭头*/

	setArrowLayer(Factory::createArrowSpriteLayer(ArrowSpriteStep3));

	/*加载怪物*/
	
	setMonsterLayer(Factory::createMonsterSpriteLayer(MonsterSpriteStep3));
