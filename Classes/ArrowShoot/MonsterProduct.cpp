...
#include "MapLayer.h"
MonsterProduct::MonsterProduct() {}

MonsterProduct::~MonsterProduct() {}

float MonsterProduct::timerand(int i) {
	float x = i;
	float rand = 0.1*(x - 4)*(x - 3) + 0.2*(x - 2)*(x - 1);
	return rand;
}

void MonsterProduct::monsterNumberDecrease() {
	monsterNumber--;
}

void MonsterProduct::setMonstersPosition(TMXObjectGroup* monsterObjectGroup) {
	char monstername[20];
...
int MonsterProduct::getMonsterNumber() {
	return monsterNumber;
}

void MonsterProduct::onContact()
{
	this->monsterNumber--;
	_observer->onEventHappen(this, Contact);
}

void MonsterProduct::addObserver(Observer * observer)
{
	_observer = observer;
}

void MonsterProduct::update(float dt) {
	/*更新怪物计数图标*/
...
void MonsterProduct::addMonster() {
...
MonsterProduct * Monster1::operationMonster()
{
	return Monster1::create();
}
...
MonsterProduct * Monster2::operationMonster()
{
	return Monster2::create();
}
...
MonsterProduct * Monster3::operationMonster()
{
	return Monster3::create();
}